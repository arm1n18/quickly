...
import { IconComponent, DropdownComponent, ButtonComponent } from 'app/shared/ui';
import { DropdownItem } from 'app/shared/ui/dropdown/dropdown.component';
import { shuffleArray } from 'app/shared/utils/random.utils';
import { AnswerOption, MissingWordData, MissingWordSentence, MissingWordPlaceholder } from '../../models/missing-words.interface';

type Mode = 'dropdown' | 'input'

@Component({
  selector: 'app-missing-words-page',
  imports: [NgClass, IconComponent, DropdownComponent, ButtonComponent],
  templateUrl: './missing-words.page.html',
  styleUrl: './missing-words.page.css',
})

export class MissingWordsPageComponent {
