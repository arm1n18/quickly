import { ButtonComponent, IconComponent, DropdownComponent } from 'app/shared/ui';
import { DropdownConfig, DropdownItem } from 'app/shared/ui/dropdown/dropdown.component';
import { NgStyle } from '@angular/common';
import { Component, Input, OnInit, signal, WritableSignal } from '@angular/core';
import { ActivatedRoute, Router } from '@angular/router';
import { GameMode } from '../../models/test-card.interface';
