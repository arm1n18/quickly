...
import {TestTFCard} from '../../../interfaces/module.interface';
...
@Component({
  ...
  templateUrl: './tf-question.html',
  styleUrl: './tf-question.css'
})
export class TfQuestionComponent implements OnChanges {
