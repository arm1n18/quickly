...
import { ChooseQuestionComponent, InputQuestionComponent, TfQuestionComponent, MatchQuestionComponent } from '../../components'
import {
  TestAnswer,
  Card,
  TestQACard,
...
@Component({
  ...
  imports: [
    ChooseQuestionComponent, TfQuestionComponent,
    InputQuestionComponent, NgClass, FormsModule,
    NgStyle,
    DropdownComponent,
