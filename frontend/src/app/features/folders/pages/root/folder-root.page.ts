...
import { AvatarComponent, ButtonComponent, ConfirmModalComponent, DropdownComponent, IconComponent, InputComponent, ModalComponent, SegmentedControlsComponent } from 'app/shared/ui';
...
@Component({
  ...
  templateUrl: './folder-root.page.html',
  styleUrl: './folder-root.page.css',
})

export class FolderRootPage implements OnInit {
  constructor(
