...
import {TestQACard} from '../../interfaces/quizCard.interface';
...
@Component({
  selector: 'app-test-choose-question',
  imports: [
    Icon,
    NgClass,
    CustomButton,
  ...
  templateUrl: './test-choose-question.html',
  styleUrl: './test-choose-question.css'
})
export class TestChooseQuestion implements OnChanges {
