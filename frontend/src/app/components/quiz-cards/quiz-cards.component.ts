...
import { CustomButtonComponent, IconComponent, DropdownComponent, DropdownItem, ModalComponent } from "../ui";
...
@Component({
  ...
  imports: [NgStyle, CustomButtonComponent, IconComponent, DropdownComponent, QuizCardComponent, NgClass],
