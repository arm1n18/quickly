...
import { ContentBlock } from 'app/features/cards/models/cards.interface';
import { IconComponent } from 'app/shared/ui';
import { Feedback } from 'app/shared/utils/feedback.utils';
import { TestMatchCard } from '../../../models/test-card.interface';
...
@Component({
  ...
  styleUrl: './match-question.component.css'
})
